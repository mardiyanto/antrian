...
<html lang="en">
  ...
  <body>
    <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-2"><a href="antri.php">APM</a></h1>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
			...
			<div class="col-4 pt-1 pb-1">
              <div id="printAntrianLoket5" style="display: none;" class="cetak">
                <div style="width: 180px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                  <div id="print_nomor_loket5"></div>
                 PENDAFTARAN
                </div>
              </div>
              <div id="display_nomor_loket5"></div>
              <form role="form" id="formloket5" name="formloket5">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM5" value="Submit" name="btnKRM5" onclick="printDiv('printAntrianLoket5');">PENDAFTARAN</button>
              </form>
            </div>
            <div class="col-4 pt-1 pb-1">
              ...
              <form role="form" id="formloket" name="formloket">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM" value="Submit" name="btnKRM" onclick="printDiv('printAntrianLoket');">POLI PARU</button>
              </form>
            </div>
			<div class="col-4 pt-1 pb-1">
              <div id="printAntrianLoket1" style="display: none;" class="cetak">
                <div style="width: 180px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                  <div id="print_nomor_loket1"></div>
                  POLI OBGYN
                </div>
              </div>
              <div id="display_nomor_loket1"></div>
              <form role="form" id="formloket1" name="formloket1">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM1" value="Submit" name="btnKRM1" onclick="printDiv('printAntrianLoket1');">POLI OBGYN</button>
              </form>
            </div>
			<div class="col-4 pt-1 pb-1">
              <div id="printAntrianLoket2" style="display: none;" class="cetak">
                <div style="width: 180px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                  <div id="print_nomor_loket2"></div>
                  POLI BEDAH
                </div>
              </div>
              <div id="display_nomor_loket2"></div>
              <form role="form" id="formloket2" name="formloket2">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM2" value="Submit" name="btnKRM2" onclick="printDiv('printAntrianLoket2');">POLI BEDAH</button>
              </form>
            </div>
			<div class="col-4 pt-1 pb-1">
              <div id="printAntrianLoket3" style="display: none;" class="cetak">
                <div style="width: 180px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                  <div id="print_nomor_loket3"></div>
                  POLI ANAK
                </div>
              </div>
              <div id="display_nomor_loket3"></div>
              <form role="form" id="formloket3" name="formloket3">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM3" value="Submit" name="btnKRM3" onclick="printDiv('printAntrianLoket3');">POLI ANAK</button>
              </form>
            </div>
			<div class="col-4 pt-1 pb-1">
              <div id="printAntrianLoket4" style="display: none;" class="cetak">
                <div style="width: 180px; font-family: Tahoma; margin-top: 10px; margin-right: 5px; margin-bottom: 100px; margin-left: 15px; font-size: 21px !important;">
                  <div id="print_nomor_loket4"></div>
                  POLI DALAM
                </div>
              </div>
              <div id="display_nomor_loket4"></div>
              <form role="form" id="formloket4" name="formloket4">
                <button type="submit" class="btn btn-lg btn-danger btn-block" id="btnKRM4" value="Submit" name="btnKRM4" onclick="printDiv('printAntrianLoket4');">POLI DALAM</button>
              </form>
            </div>
            <div class="col-4 pt-1 pb-1">
    ...
    $(document).ready(function() {
	  ...
	  $("#display_nomor_loket1").load("get-antrian.php?aksi=tampilloket1");
      $("#print_nomor_loket1").load("get-antrian.php?aksi=printloket1");
	  $("#display_nomor_loket2").load("get-antrian.php?aksi=tampilloket2");
      $("#print_nomor_loket2").load("get-antrian.php?aksi=printloket2");
	  $("#display_nomor_loket3").load("get-antrian.php?aksi=tampilloket3");
      $("#print_nomor_loket3").load("get-antrian.php?aksi=printloket3");
	  $("#display_nomor_loket4").load("get-antrian.php?aksi=tampilloket4");
      $("#print_nomor_loket4").load("get-antrian.php?aksi=printloket4");
	   $("#display_nomor_loket5").load("get-antrian.php?aksi=tampilloket5");
      $("#print_nomor_loket5").load("get-antrian.php?aksi=printloket5");
