...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-3 ">
        <a href="antrian.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">ADMISI</div>
            </div>
          </div>
        </a>
      </div>
	<div class="col-3 ">
        <a href="paru.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">POLI PARU</div>
            </div>
          </div>
        </a>
      </div>
	  	<div class="col-3 ">
        <a href="obg.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">POLI OBGYN</div>
            </div>
          </div>
        </a>
      </div>
	  	  	<div class="col-3 ">
        <a href="anak.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">POLI ANAK</div>
            </div>
          </div>
        </a>
      </div>
	  <div class="col-3 ">
        <a href="bedah.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">POLI BEDAH</div>
            </div>
          </div>
        </a>
      </div>
	  	  <div class="col-3 ">
        <a href="dalam.php" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:50px;font-weight:lighter;padding:0;margin-top:-15px;margin-bottom:-15px;">POLI DALAM</div>
            </div>
          </div>
        </a>
      </div>
